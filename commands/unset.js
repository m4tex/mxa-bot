...
module.exports = ***REMOVED***
    ...
    execute: async function (msg, args) ***REMOVED***
        if (args[0] === 'dev') ***REMOVED***
            if (await collections.devchannels.countDocuments(***REMOVED*** channelID: msg.channelId ***REMOVED***, ***REMOVED*** limit: 1***REMOVED***) === 1) ***REMOVED***
                await collections.devchannels.deleteOne(***REMOVED*** channelID: msg.channelId ***REMOVED***)
